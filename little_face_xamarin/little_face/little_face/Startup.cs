...
using little_face.Helpers.HttpMessageHandlers;
...
namespace little_face
{
    public static class Startup
    {
        ...
        private const string VIEW_MODELS_NAMESPACE = "little_face.ViewModels";
        ...
        static Startup()
        {
            ...
            serviceCollection.AddRefitClient<IChildApi>(refitSettings)
                .ConfigureHttpClient(c => c.BaseAddress = new Uri(Settings.ApiBaseUri))
                .AddHttpMessageHandler<BaseAddressHandler>();

            serviceCollection.AddRefitClient<IGoalApi>(refitSettings)
                .ConfigureHttpClient(c => c.BaseAddress = new Uri(Settings.ApiBaseUri))
                .AddHttpMessageHandler<BaseAddressHandler>();
            ...
            serviceCollection.AddRefitClient<IGoalChildApi>(refitSettings)
                .ConfigureHttpClient(c => c.BaseAddress = new Uri(Settings.ApiBaseUri))
                .AddHttpMessageHandler<BaseAddressHandler>();
